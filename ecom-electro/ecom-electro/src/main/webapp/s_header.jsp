		...
		<div id="top-header">
			<div class="container">
				...
				<ul class="header-links pull-right">
					...
					<li><a href="s_myProfile.jsp"><i class="fa fa-user"></i>
							My Profile</a></li>
					<li><a href="s_contactUs.jsp"><i
					...
					<%
								...
								%>
					<li><a href="#"><i class="fa fa-address-book"></i> Contact
							Us</a></li>
		...
		%>
					...
					<div class="col-md-3 clearfix">
						<div class="header-ctn">
							<!-- Add Product -->
							<div>
								<a href="s_addProduct.jsp"> <i class="fa fa-plus"></i> <span>Add
										Product</span>
								</a>
							</div>
							<!-- /Add Product -->
							...
							<!-- view Product -->
							<div class="dropdown">
								<a href="s_viewProduct.jsp"> <i class="fa fa-eye"></i> <span>View
										Product</span>
								</a>
							</div>
							<!-- /view Product -->
