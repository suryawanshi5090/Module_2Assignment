			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="product-details">
						...
						<div class="add-to-cart">
							<div class="qty-label">
								...
								<div class="input-number">
									<input type="number" value="<%=p.getPunit()%>"
										readonly="readonly">
								</div>
							</div>
						...
						<div class="add-to-cart">
							<a href="s_editProduct.jsp?pid=<%=p.getPid()%>"><input
								type="submit" name="action" value="Edit Product"
								class="btn btn-primary"></a> <a
								href="s_deleteProduct.jsp?pid=<%=p.getPid()%>"><input
								type="submit" name="action" value="Delete Product"
								class="btn btn-danger" style="margin: 5px"></a>
						</div>
								...
								<div class="products-slick" data-nav="#slick-nav-1">
									...
									<div class="product">
										<div class="product-img">
											<a href="s_product.jsp?pid=<%=p1.getPid()%>"><img
										...
										<div class="product-body">
											...
											<h3 class="product-name">
												<a href="s_product.jsp?pid=<%=p1.getPid()%>"><%=p1.getPname() %></a>
											</h3>
